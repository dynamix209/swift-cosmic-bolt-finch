...
//#region node_modules/.nitro/vite/services/ssr/assets/router-C5p8OOaw.js
...
var styles_default = "/assets/styles-Ce_AV-py.css";
var APP_NAME = "HEIST — BNA";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "HEIST — the official BOBUX exchange and perk vault for Beaconhouse Notion of Academia."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-Bry9EOXA.mjs");
